...
const BADGE: Record<Coluna, string> = {
  ...
  entregue: "bg-blue-500/10 text-blue-600 dark:text-blue-400 border border-blue-500/30",
        ...
        <div className="mt-5 flex flex-wrap gap-2">
          {wa && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1.5 rounded-lg bg-blue-500 px-3 py-2 text-sm font-medium text-white transition hover:bg-blue-400"
            >
              Abrir no WhatsApp
            </a>
          )}
    ...
    <div className="flex items-center justify-between gap-3">
      ...
      <dd className="flex min-w-0 items-center gap-2 text-right">
        ...
        {acao && (
          <button
            onClick={acao}
            className="shrink-0 text-xs text-blue-600 dark:text-blue-400 hover:text-blue-500"
          >
