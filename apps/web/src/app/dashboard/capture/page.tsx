...
export default async function CapturePage() {
  ...
  return (
    <div>
      ...
      <div className="mt-6 rounded-xl border border-amber-500/30 bg-amber-500/5 p-4 text-sm text-amber-200/90">
      ...
      {jobs.length === 0 ? (
        <div className="mt-10 rounded-2xl border border-dashed border-neutral-800 bg-neutral-900/30 p-12 text-center">
          ...
          <h2 className="mt-3 font-medium text-white">Nenhuma captação ainda</h2>
